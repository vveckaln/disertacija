...
kur $f(\chi)$ ir plūsmas distribūcijas blīvums.
...
\input{nodalas_kopsavilkums/results/Rvalues_SMlv/R_L_reco_data_N_SM.txt}

\input{nodalas_kopsavilkums/results/Rvalues_cfliplv/R_L_reco_MC_N_cflip.txt}

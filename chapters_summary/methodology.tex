...
\begin{figure}[hbtp]
    ...
    \caption{Track reconstruction efficiencies for pions passing the high-purity quality requirements. Results are shown as a function of $\eta$ (left), for \pt=1, 10, and 100\GeV. They are also shown as a function of \pt (right), for the barrel, transition, and endcap regions, which are defined by the $\eta$ intervals of 0--0.9, 0.9--1.4 and 1.4--2.5, respectively. \cite{Chatrchyan:2014fea}}
...
\begin{figure}[hbtp]
  \centering
  \includegraphics[width=0.6\textwidth]{fig/L3method_adaptation.pdf}
